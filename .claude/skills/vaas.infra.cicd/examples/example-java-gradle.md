...
Proyecto `documents-api` — API Java 17 + Spring Boot + Gradle, desplegada en ECS.
...
```groovy
def TASK_DEFINITION_NAME = "documents-api"
def REPOSITORY_NAME = "documents-api-repository"
def COLOR_MAP = [
    SUCCESS: 'good',
    FAILURE: 'danger'
]
